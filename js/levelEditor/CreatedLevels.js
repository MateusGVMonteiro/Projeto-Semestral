function CreatedLevels() {
  ...
  this.startLevel = function(i) {
    ...
    var map = { 1: level }; //sempre apenas um nível nos mapas salvos.
  ...
  this.removeCreatedLevelsScreen = function() {
    if (levelsWrapper) {
      ...
      while (levelsWrapper.hasChildNodes()) {
        //remove todos os níveis criados na tela, para que possa ser iniciado novamente mostrando novos níveis que o usuário cria
